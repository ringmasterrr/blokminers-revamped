    ...
    return (
        <div className='mb-20 mt-20 w-full'>
            <div className='grid w-full grid-cols-3 gap-4'>
                <div className='card relative col-span-2 flex h-[350px] flex-col gap-4 rounded-xl px-6 py-8'>
                    <h1 className='text-4xl font-extrabold text-theme-dark'>
                        Blockchain Development
                    </h1>
                    <p className='font-semibold text-lg text-theme-dark'>
                ...
                <div className='card relative flex h-[350px] flex-col gap-4 rounded-xl px-6 py-8'>
                    <h1 className='text-4xl font-extrabold text-theme-dark'>
                        Web3 Development
                    </h1>
                    <p className='font-semibold text-lg text-theme-dark'>
                ...
                <div className='card relative row-span-2  h-[full]  rounded-xl px-6 py-8'>
                ...
                <div className='card relative col-span-2 flex justify-end  h-[350px]  rounded-xl px-6 py-8'>
                    <div className='flex-col gap-4 flex w-[50%] text-end '>
                ...
                <div className='card relative flex h-[350px] flex-col gap-4 rounded-xl px-6 py-8'>
                    ...
                    <p className='font-semibold text-lg text-theme-dark'>
                        Proactive measures and solutions to protect
                ...
                <div className='card relative col-span-3 flex h-[350px] justify-end rounded-xl px-6 py-8'>
                    <div className='flex-col gap-4 flex w-[50%] text-end '>
                        <h1 className='text-4xl font-extrabold text-theme-dark'>
                            AI/ML Blockchain Development
                        </h1>
                        <p className='font-semibold text-lg text-theme-dark w-[75%] ml-auto'>
                            Uniting the realms of AI/ML and blockchain, we pioneer solutions that
                            marry the strengths of both technologies.
                        </p>
                    </div>
