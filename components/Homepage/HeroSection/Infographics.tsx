    ...
    <div className='flex h-full w-full items-center justify-center py-12 xl:overflow-clip xl:pb-64 xl:pt-44'>
      <div className='relative z-50 flex h-[23rem] w-[23rem] items-center justify-center xl:ml-16 xl:translate-x-40'>
        <div className='animate-spin-superslow absolute flex h-[18.5rem] w-[18.5rem] items-center justify-center rounded-full border-2 border-gray-300 xl:h-[38rem] xl:w-[38rem]'>
          <div className='absolute -top-7 right-24 transform xl:-top-0'>
            <Image
              src={'/orbit-icons/eth.svg'}
              alt=''
              width={200}
              height={200}
              className='w-14 -rotate-[20deg] xl:w-24 xl:rotate-12'
            />
            <div className='absolute -right-[25%] top-[66%] h-2 w-2 transform rounded-full bg-black/80 p-1 xl:top-[100%]'></div>
          </div>
          <div className='absolute -bottom-6 left-24 transform xl:-bottom-0'>
            <Image
              src={'/orbit-icons/polygon.svg'}
              alt=''
              width={200}
              height={200}
              className='w-12 rotate-[80deg] xl:w-20 xl:rotate-[100deg]'
            />
          ...
          <div className='animate-spin-slow absolute flex h-[14rem] w-[14rem] items-center justify-center rounded-full border-2 border-gray-400 xl:h-[28rem] xl:w-[28rem]'>
            ...
            <div className='absolute -bottom-5 left-24 transform'>
              <Image
                ...
                className='w-10 xl:w-16'
              />
              <div className='absolute bottom-[60%] right-[160%] h-2 w-2 transform rounded-full bg-black/80 p-1 xl:bottom-[135%]'></div>
            </div>
            <div className='animate-spin-slower absolute flex h-[9rem] w-[9rem] items-center justify-center rounded-full border-2 border-gray-500 xl:h-[18rem] xl:w-[18rem]'>
              <div className='absolute -top-5 right-14 transform'>
                <Image
                  ...
                  width={200}
                  height={200}
                  className='w-12 -rotate-12 xl:w-16'
                />
                <div className='absolute right-[160%] top-[130%] h-3 w-3 transform rounded-full bg-black/80 p-1 xl:top-[30%]'></div>
              </div>
              <div className='animate-spin-slowest absolute flex h-16 w-16 items-center justify-center rounded-full border-2 border-gray-500 xl:h-32 xl:w-32'>
                <div className='absolute -top-7 transform'>
                  <Image
                    ...
                    className='w-10 xl:w-16'
                  />
                  <div className='absolute -bottom-[20%] right-[110%] h-2 w-2 transform rounded-full bg-black/80 p-1 xl:-bottom-[80%] xl:right-[137%]'></div>
                </div>
              </div>
            </div>
          </div>
