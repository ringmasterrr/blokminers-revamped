    ...
    return (
        <div className='w-fit flex gap-8'>
            <div className='flex flex-col text-theme-dark'>
                <div
                    className='bg-gradient-to-b from-[#00283C] via-[#00283C] via-20% to-[#fff] bg-clip-text text-8xl font-extrabold text-transparent'
                >
                    {Math.round(years)}+
                </div>
                <div className="font-extrabold mt-[-25px]">YEARS</div>
            ...
            <div className='flex flex-col text-theme-dark'>
                ...
                <div className="font-extrabold mt-[-25px]">PROJECTS</div>
            ...
            <div className='flex flex-col text-theme-dark'>
                ...
                <div className="font-extrabold mt-[-25px]">CLIENTS</div>
