...
const content = [
  ...
  },
  {
    ...
    image: '/OurProcess/architect1.svg',
  },
  {
    title: 'Design',
    description:
      'We lay out a detailed conceptual workflow by collaborating closely with you to see how your idea becomes a product. We’ll determine the relevance of Blockchain to your project, the best Blockchain model to deploy, gain clarity on the specifics of your idea and work with it.',
    image: '/OurProcess/design1.svg',
  },
  {
    title: 'Build',
    description:
      'This is the skeletal framework of the project and at this point, we decide the Blockchain protocol based on type, energy efficiency, bridging strength and cost. We’ll also develop frameworks and determine smart contracts, business logic and storage.',
    image: '/OurProcess/build1.svg',
  },
  {
    title: 'Test',
    description:
      'We lay out a detailed conceptual workflow by collaborating closely with you to see how your idea becomes a product. We’ll determine the relevance of Blockchain to your project, the best Blockchain model to deploy, gain clarity on the specifics of your idea and work with it.',
    image: '/OurProcess/test1.svg',
  },
  {
    title: 'Launch',
    description:
        ...
        >
          {index % 2 === 0 ? (
            ...
            >
              ...
              <div className='glassy-bg flex h-[24rem] w-[20rem] items-center justify-center rounded-2xl p-8 py-10 2md:w-[36rem]'>
                <Image
                  src={item.image}
                  alt={item.title}
                  width={300}
                  height={300}
                  className='h-full 2md:w-full'
                />
              </div>
            </motion.div>
          ) : (
            ...
            >
              <div className='glassy-bg flex h-[24rem] w-[20rem] translate-x-5 translate-y-5 items-center justify-center rounded-2xl p-8 !py-10 2md:w-[36rem] 2md:translate-x-20 2md:translate-y-0'>
                <Image
                  src={item.image}
                  alt={item.title}
                  width={300}
