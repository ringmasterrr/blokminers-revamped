...
export const hoverContentData = {
  ...
  'Healthcare': (
    <div className='flex flex-col items-center rounded-lg bg-[#88caec] bg-opacity-10  p-10 text-center text-lg font-semibold text-theme-dark shadow-md'>
      <h2 className='mb-6 text-2xl font-bold'>Healthcare</h2>
      <p className='mb-10 text-theme-light'>
      ...
      <ul className='w-full list-outside list-disc pl-4 text-left'>
        <li className='mb-4'>
  ...
  'Insurance': (
    <div className='flex flex-col items-center rounded-lg bg-[#88caec] bg-opacity-10  p-10 text-center text-lg font-semibold text-theme-dark shadow-md'>
      <h2 className='mb-6 text-2xl font-bold'>Insurance</h2>
      <p className='mb-10 text-theme-light'>
  ...
  'Real Estate': (
    <div className='flex flex-col items-center rounded-lg bg-[#88caec] bg-opacity-10  p-10 text-center text-lg font-semibold text-theme-dark shadow-md'>
      <h2 className='mb-6 text-2xl font-bold'>Real Estate</h2>
      <p className='mb-10 text-theme-light'>
        We empower the real estate sector to provide beyond property – the
        commitment to enhancing clients' lifestyles
      </p>
  ...
  'Travel & Logistics': (
    <div className='flex flex-col items-center rounded-lg bg-[#88caec] bg-opacity-10  p-10 text-center text-lg font-semibold text-theme-dark shadow-md'>
      <h2 className='mb-6 text-2xl font-bold'>Travel & Logistics</h2>
      <p className='mb-10 text-theme-light'>
  ...
  'Retail': (
    <div className='flex flex-col items-center rounded-lg bg-[#88caec] bg-opacity-10  p-10 text-center text-lg font-semibold text-theme-dark shadow-md'>
      <h2 className='mb-6 text-2xl font-bold'>Retail</h2>
      <p className='mb-10 text-theme-light'>
